...
function MediumLogo(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M13.54 12c0 4.1-2.93 7.44-6.54 7.44S.46 16.1.46 12s2.92-7.44 6.53-7.44 6.55 3.33 6.55 7.44zm6.7-7.22h-3.23c-.26 0-.48.22-.48.48v13.48c0 .26.22.48.48.48h3.23c.27 0 .48-.22.48-.48V5.26c0-.26-.21-.48-.48-.48zm5.3-.24h-3.23c-.27 0-.48.22-.48.48v13.48c0 .27.21.48.48.48h3.23c.27 0 .48-.22.48-.48V4.78c0-.27-.21-.48-.48-.48z"/>
    </svg>
  );
}
